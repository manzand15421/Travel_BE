...
const config = {
  ...
  "inlineSchemaHash": "b52c994b3e0fd0aaa617b20d5825081eb03675263c5530d4412bcd33303c74bb",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/generated/client-dbSC",
    "generated/client-dbSC",
  ]
...
path.join(process.cwd(), "prisma/generated/client-dbSC/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/generated/client-dbSC/schema.prisma")
